...
class SubjectController extends Controller
{
    public function index(Request $request)
    {
                    ...
                    $actionBtn = '
                            <button class="btn btn-primary btn-border dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action</button>
                                    <div class="dropdown-menu">
                                        <a href="'.@route('staff.subjects-edit-page',['subject_id' => $row->id]).'"  class="dropdown-item">Edit Subject</a> <a href="'.@route('staff.subjects-delete',['subject_id' => $row->id]).'" class="dropdown-item confirm_delete">Delete Subject</a> <a href="'.@route('staff.subjects-status',['subject_id' => $row->id, 'status' =>$status]).'" class="dropdown-item confirm_status" title="'.$title.'">'.$text.'</a>
                                    </div>';
                    return $actionBtn;
                })
                ->rawColumns(['action'])
        ...
        return view('staff.advanced-features.subjects.index', $data);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('staff.advanced-features.subjects.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        try 
        {
            ...
            return redirect()->route('staff.subjects-index-page')->with('success', 'Subject created successfully');
        } catch (Exception $e) {
            return redirect()->route('staff.subjects-index-page')->with('error', 'Oops something went wrong');
        }
    }
    ...
    public function edit(Request $request, $subject_id)
    {
        ...
        if(is_null($data['subject'])){
            return redirect()->route('staff.subjects-index-page')->with('error', 'Subject not found');
        }
        $data['title'] = 'Edit Subject';
        return view('staff.advanced-features.subjects.edit', $data);
    }
    ...
    public function update(Request $request, $subject_id)
    {
        ...
        try 
        {
            ...
            return redirect()->route('staff.subjects-index-page')->with('success', 'Subject updated successfully');
        } catch (Exception $e) {
            return redirect()->route('staff.subjects-edit-page',['subject_id' => $subject_id])->with('error', 'Oops something went wrong');
        }
    }
    ...
    public function delete(Request $request, $subject_id){
        ...
        try {
            ...
            return redirect()->route('staff.subjects-index-page')->with('success', 'Subject removed successfully');
        } catch (Exception $e) {
            return redirect()->route('staff.subjects-index-page')->with('error', 'Oops something went wrong');
        }
    }
    ...
    public function status(Request $request, $subject_id, $status){
        ...
        try {
            Subject::where('id',$subject_id)->update($update);
            return redirect()->route('staff.subjects-index-page')->with('success', 'Subject status updated successfully');
        } catch (Exception $e) {
            return redirect()->route('staff.subjects-index-page')->with('error', 'Oops something went wrong');
        }
    }
    ...
    public function subjectOptional(Request $request)
    {
        ...
        return view('staff.advanced-features.subjects.subject-optionals', $data);
    }
