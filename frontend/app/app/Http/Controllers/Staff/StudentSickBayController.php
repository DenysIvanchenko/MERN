...
class StudentSickBayController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('staff.advanced-features.students-sick-bay.index', $data);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('staff.advanced-features.students-sick-bay.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        try 
        {
            ...
            return redirect()->route('staff.students.sick-health-index-page')->with('success', 'Sick bay added successfully');
        } catch (Exception $e) {
            return redirect()->route('staff.students.sick-health-index-page')->with('error', 'Oops something went wrong');
        }
    }
}
