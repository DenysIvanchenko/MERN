...
class NewCurriculamExamController extends Controller
{
    public function index(Request $request){
        ...
        return view('staff.new-curriculam.exams.to_marks',$data);
    }
    ...
    public function addExamMarks(Request $request)
    {
        ...
        try 
        {
            ...
            return redirect()->route('staff.new-curriculam-exams-index-page')->with('success', 'Exam created successfully');
        } catch (Exception $e) {
            return redirect()->route('staff.new-curriculam-exams-index-page')->with('error', 'Oops something went wrong');
        }
    }
    ...
    public function examMarksView(Request $request)
    {
        ...
        return view('staff.new-curriculam.exams.exam_marks_view',$data);
    }
    ...
    public function examMarksViewPrint(Request $request)
    {
        ...
        $data['class_lists'] = SubjectClass::where('is_deleted', 'no')->where('class_status','active')->where('class_curriculam','new_curriculam')->get();
        return view('staff.new-curriculam.exams.exam_marks_view_print',$data);
    }
    ...
    public function reportComments(Request $request)
    {
        ...
        $data['class_lists'] = SubjectClass::where('is_deleted', 'no')->where('class_status','active')->where('class_curriculam','new_curriculam')->get();
        return view('staff.new-curriculam.exams.report_comments',$data);
    }
    ...
    public function gamesComments(Request $request)
    {
        ...
        $data['class_lists'] = SubjectClass::where('is_deleted', 'no')->where('class_status','active')->where('class_curriculam','new_curriculam')->get();
        return view('staff.new-curriculam.exams.games_comments',$data);
    }  
    ...
    public function clubsComments(Request $request)
    {
        ...
        $data['class_lists'] = SubjectClass::where('is_deleted', 'no')->where('class_status','active')->where('class_curriculam','new_curriculam')->get();
        return view('staff.new-curriculam.exams.club_comments',$data);
    }
    ...
    public function projectComments(Request $request)
    {
        ...
        $data['class_lists'] = SubjectClass::where('is_deleted', 'no')->where('class_status','active')->where('class_curriculam','new_curriculam')->get();
        return view('staff.new-curriculam.exams.project_comments',$data);
    }
    ...
    public function valuesExhibitedComments(Request $request)
    {
        ...
        $data['class_lists'] = SubjectClass::where('is_deleted', 'no')->where('class_status','active')->where('class_curriculam','new_curriculam')->get();
        return view('staff.new-curriculam.exams.values_exhibited',$data);
    }
    ...
    public function reportCards(Request $request)
    {
        ...
        $data['class_lists'] = SubjectClass::where('is_deleted', 'no')->where('class_status','active')->where('class_curriculam','new_curriculam')->get();
        return view('staff.new-curriculam.exams.report_cards',$data);
    }
    ...
    public function reportCardsPrint(Request $request)
    {
        ...
        return view('staff.new-curriculam.exams.report_cards_print',$data);
    }
}
