...
class StudentIndiciplineController extends Controller
{
    public function ratingsIndex(Request $request)
    {
                    ...
                    $actionBtn = '
                            <button class="btn btn-primary btn-border dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action</button>
                                    <div class="dropdown-menu">
                                        <a href="'.@route('staff.indecipline-ratings-edit-page',['ratings_id' => $row->id]).'"  class="dropdown-item">Edit Rating</a> 
                                        <a href="'.@route('staff.indecipline-ratings-delete',['ratings_id' => $row->id]).'" class="dropdown-item confirm_delete">Delete Rating</a> 
                                        <a href="'.@route('staff.indecipline-ratings-status',['ratings_id' => $row->id, 'status' =>$status]).'" class="dropdown-item confirm_status" title="'.$title.'">'.$text.'</a>
                                    </div>';
                    return $actionBtn;
                })
                ->rawColumns(['action'])
        ...
        return view('staff.advanced-features.student-indicipline.ratings.index', $data);
    }

    public function createRating(Request $request)
    {
        $data['title'] = 'Create Rating';
        return view('staff.advanced-features.student-indicipline.ratings.create', $data);
    }
    ...
    public function storeRating(Request $request)
    {
        ...
        try 
        {
            ...
            return redirect()->route('staff.indecipline-ratings-index-page')->with('success', 'Rating added successfully');
        } catch (Exception $e) {
            return redirect()->route('staff.indecipline-ratings-index-page')->with('error', 'Oops somthing went wrong');
        }
    }
    ...
    public function editRating(Request $request, $rating_id)
    {
        ...
        if(is_null($data['rating'])){
            return redirect()->route('staff.indecipline-ratings-index-page')->with('error', 'Rating not found');
        }
        $data['title'] = 'Edit Rating';
        return view('staff.advanced-features.student-indicipline.ratings.edit', $data);
    }
    ...
    public function updateRating(Request $request, $rating_id)
    {
        ...
        try 
        {
            ...
            return redirect()->route('staff.indecipline-ratings-index-page')->with('success', 'Rating updated successfully'); 
        } catch (Exception $e) {
            return redirect()->route('staff.indecipline-ratings-index-page')->with('error', 'Oops somthing went wrong');
        }
    }
    ...
    public function deleteRating(Request $request, $rating_id){
        ...
        try {
            ...
            return redirect()->route('staff.indecipline-ratings-index-page')->with('success', 'Rating removed successfully');
        } catch (Exception $e) {
            return redirect()->route('staff.indecipline-ratings-index-page')->with('error', 'Oops something went wrong');
        }
    }
    ...
    public function ratingStatus(Request $request, $rating_id, $status){
        ...
        try {
            StudentIndiciplineRating::where('id',$rating_id)->update($update);
            return redirect()->route('staff.indecipline-ratings-index-page')->with('success', 'Rating status updated successfully');
        } catch (Exception $e) {
            return redirect()->route('staff.indecipline-ratings-index-page')->with('error', 'Oops something went wrong');
        }
    }
    ...
    public function categoryIndex(Request $request)
    {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function($row){
                    ...
                    $actionBtn = '
                            <button class="btn btn-primary btn-border dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action</button>
                                    <div class="dropdown-menu">
                                        <a href="'.@route('staff.indecipline-category-edit-page',['category_ids' => $row->id]).'"  class="dropdown-item">Edit Category</a> 
                                        <a href="'.@route('staff.indecipline-category-delete',['category_ids' => $row->id]).'" class="dropdown-item confirm_delete">Delete Category</a> 
                                        <a href="'.@route('staff.indecipline-category-status',['category_ids' => $row->id, 'status' =>$status]).'" class="dropdown-item confirm_status" title="'.$title.'">'.$text.'</a>
                                    </div>';
                    return $actionBtn;
                })
                ->rawColumns(['action'])
        ...
        $data['title'] = 'Papers List';
        return view('staff.advanced-features.student-indicipline.category.index', $data);
    }

    public function createCategory(Request $request)
    {
        $data['title'] = 'Create Category';
        return view('staff.advanced-features.student-indicipline.category.create', $data);
    }
    ...
    public function storeCategory(Request $request)
    {
        ...
        try 
        {
            ...
            return redirect()->route('staff.indecipline-category-index-page')->with('success', 'Category added successfully');
        } catch (Exception $e) {
            return redirect()->route('staff.indecipline-category-index-page')->with('error', 'Oops somthing went wrong');
        }
    }
    ...
    public function editCategory(Request $request, $rating_id)
    {
        ...
        if(is_null($data['category'])){
            return redirect()->route('staff.indecipline-ratings-index-page')->with('error', 'Category not found');
        }
        $data['title'] = 'Edit Rating';
        return view('staff.advanced-features.student-indicipline.category.edit', $data);
    }
    ...
    public function updateCategory(Request $request, $category_ids)
    {
        ...
        try 
        {
            ...
            return redirect()->route('staff.indecipline-category-index-page')->with('success', 'Category updated successfully');
        } catch (Exception $e) {
            return redirect()->route('staff.indecipline-category-index-page')->with('error', 'Oops somthing went wrong');
        }
    }
    ...
    public function deleteCategory(Request $request, $category_ids){
        ...
        try {
            ...
            return redirect()->route('staff.indecipline-category-index-page')->with('success', 'Category removed successfully');
        } catch (Exception $e) {
            return redirect()->route('staff.indecipline-category-index-page')->with('error', 'Oops something went wrong');
        }
    }
    ...
    public function categoryStatus(Request $request, $category_ids, $status){
        ...
        try {
            StudentIndiciplineCategory::where('id',$category_ids)->update($update);
            return redirect()->route('staff.indecipline-category-index-page')->with('success', 'Category status updated successfully');
        } catch (Exception $e) {
            return redirect()->route('staff.indecipline-category-index-page')->with('error', 'Oops something went wrong');
        }
    }
    ...
    public function caseIndex(Request $request)
    {
        ...
        $data['title'] = 'Papers List';
        return view('staff.advanced-features.student-indicipline.index', $data);
    }
    ...
    public function createCase(Request $request)
    {
        ...
        return view('staff.advanced-features.student-indicipline.create', $data);
    }
    ...
    public function storeCase(Request $request)
    {
        ...
        try 
        {
            ...
            return redirect()->route('staff.indecipline-case-index-page')->with('success', 'Case added successfully');
        } catch (Exception $e) {
            return redirect()->route('staff.indecipline-case-index-page')->with('error', 'Oops something went wrong');
        }
    }
}
