...
class SubjectPaperController extends Controller
{
    public function index(Request $request)
    {
                    ...
                    $actionBtn = '
                            <button class="btn btn-primary btn-border dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action</button>
                                    <div class="dropdown-menu">
                                        <a href="'.@route('admin.subject-papers-edit-page',['paper_id' => $row->id]).'"  class="dropdown-item">Edit Paper</a> <a href="'.@route('admin.subject-papers-delete',['paper_id' => $row->id]).'" class="dropdown-item confirm_delete">Delete Paper</a>
                                    </div>';
                    return $actionBtn;
                })
                ->rawColumns(['action'])
        ...
        return view('admin.advanced-features.subjects.papers.index', $data);
    }
    ...
    public function papersAttempted(Request $request)
    {
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function($row){
                    ...
                    $actionBtn = '<a href="'.@route('admin.subject-papers-status',['paper_id' => $row->id, 'status' =>$status]).'" class="btn '.$class.' confirm_status" title="'.$title.'">'.$text.'</a>';
                    return $actionBtn;
                })
                ->rawColumns(['action'])
                ->make(true);
        ...
        $data['title'] = 'Papers List';
        return view('admin.advanced-features.subjects.papers.papers-attempted', $data);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.advanced-features.subjects.papers.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        try 
        {
            ...
            return redirect()->route('admin.subject-papers-index-page')->with('success', 'Paper added successfully');
        } catch (Exception $e) {
            return redirect()->route('admin.subject-papers-index-page')->with('error', 'Oops something went wrong');
        }
    }
    ...
    public function edit(Request $request, $paper_id)
    {
        ...
        return view('admin.advanced-features.subjects.papers.edit', $data);
    }
    ...
    public function delete(Request $request, $paper_id){
        ...
        try {
            ...
            return redirect()->route('admin.subject-papers-index-page')->with('success', 'Paper removed successfully');
        } catch (Exception $e) {
            return redirect()->route('admin.subject-papers-index-page')->with('error', 'Oops something went wrong');
        }
    }
    ...
    public function status(Request $request, $paper_id, $status){
        ...
        try {
            SubjectPaper::where('id',$paper_id)->update($update);
            return redirect()->route('admin.subject-papers-index-page')->with('success', 'Paper status updated successfully');
        } catch (Exception $e) {
            return redirect()->route('admin.subject-papers-index-page')->with('error', 'Oops something went wrong');
        }
    }
