...
class SubjectClassController extends Controller
{
    public function index(Request $request)
    {
                    ...
                    $actionBtn = '
                            <button class="btn btn-primary btn-border dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action</button>
                                    <div class="dropdown-menu">
                                        <a href="'.@route('admin.class-edit-page',['class_id' => $row->id]).'"  class="dropdown-item">Edit Class</a> <a href="'.@route('admin.class-delete',['class_id' => $row->id]).'" class="dropdown-item confirm_delete">Delete Class</a> <a href="'.@route('admin.class-status',['class_id' => $row->id, 'status' =>$status]).'" class="dropdown-item confirm_status" title="'.$title.'">'.$text.'</a>
                                    </div>';
                    return $actionBtn;
                })
                ->rawColumns(['action'])
        ...
        return view('admin.subject-class.index', $data);
    }

    public function create(Request $request)
    {
        $data['title'] = 'Create Class';
        return view('admin.subject-class.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        try 
        {
            ...
            return redirect()->route('admin.class-page')->with('success', 'Class created successfully');
        } catch (Exception $e) {
            return redirect()->route('admin.class-page')->with('error', 'Oops something went wrong');
        }
    }
    ...
    public function edit(Request $reques, $class_id)
    {
        ...
        if(is_null($data['class'])){
            return redirect()->route('admin.class-page')->with('error', 'Class not found');
        }
        $data['title'] = 'Create Class';
        return view('admin.subject-class.edit', $data);
    }
    ...
    public function update(Request $request, $class_id)
    {
        ...
        try 
        {
            ...
            return redirect()->route('admin.class-page')->with('success', 'Class updated successfully');
        } catch (Exception $e) {
            return redirect()->route('admin.class-page')->with('error', 'Oops something went wrong');
        }
    }
    ...
    public function delete(Request $request, $class_id){
        ...
        try {
            ...
            return redirect()->route('admin.class-page')->with('success', 'Class removed successfully');
        } catch (Exception $e) {
            return redirect()->route('admin.class-page')->with('error', 'Oops something went wrong');
        }
    }
    ...
    public function status(Request $request, $class_id, $status){
        ...
        try {
            SubjectClass::where('id',$class_id)->update($update);
            return redirect()->route('admin.class-page')->with('success', 'Class status updated successfully');
        } catch (Exception $e) {
            return redirect()->route('admin.class-page')->with('error', 'Oops something went wrong');
        }
    }
    ...
    public function curiculamSettings(Request $request)
    {
        ...
        return view('admin.subject-class.curiculamSettings', $data);
    }
    ...
    public function classFees(Request $request)
    {
        ...
        return view('admin.subject-class.classFees', $data);
    }
